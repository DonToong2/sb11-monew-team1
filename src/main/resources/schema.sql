...
CREATE INDEX IF NOT EXISTS idx_user_cleanup_batch ON user (deleted_at, id)
...
CREATE INDEX IF NOT EXISTS idx_notification_cleanup_batch ON notification (confirmed_at, id)
